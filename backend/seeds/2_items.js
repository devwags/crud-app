...
exports.seed = async function(knex) {
  ...
  await knex('items').insert([
    {  
      ...
      description: `A sewing needle, used for hand-sewing, is a long slender tool with a pointed tip at one end and a hole (or eye) to hold the sewing thread. The earliest needles were made of bone or wood; modern needles are manufactured from high carbon steel wire and are nickel- or 18K gold-plated for corrosion resistance. High-quality embroidery needles are plated with two-thirds platinum and one-third titanium alloy. Traditionally, needles have been kept in needle books or needlecases which have become objects of adornment. Sewing needles may also be kept in an étui, a small box that held needles and other items such as scissors, pencils and tweezers.`, 
      quantity: 10,
      imageUrl: 'https://img.kwcdn.com/product/Fancyalgo/VirtualModelMatting/c432d807bc8b80b9fc0a54b9b7654d03.jpg?imageView2/2/w/800/q/70'
    },
    { 
      userId: 1, 
      itemName: 'Thread', 
